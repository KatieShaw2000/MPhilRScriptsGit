...
vcmax <- parms[,c(1,2)]
vcmax <- vcmax[order(vcmax$TPU_Vcmax),]
...
output_dir <- ("~/OneDrive - University of Cambridge/MPhil/Phenotyping Campaign/Hyperspectral files/Vcmax modelling")
